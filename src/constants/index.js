...
export const JobDetails = [
  ...
  },
  {
    name: "Paper2u (깨끗한나라 B2B 페이지)",
    period: "2024-04-08 ~ 2024-05-17",
    content: "Paper2u(페이퍼투유)는 깨끗한나라(화장지)회사와, 자사와의 B2B 사업을 진행하기 위해 자사에서 페이지 개발을 진행하였으며 현재 깨끗한나라와 계약 협상중에 있으며, Paper2u(페이퍼투유) 페이지는 깨끗한나라의 하청업체들의 제지 수량과 제고파악을 좀 더 원활하고 실시간으로 파악하기 위해서 개발을 진행하게 되었습니다."
  },
  {
    name: "HangCok 쇼핑몰",
    period: "024-01-16 ~ 2024-03-29",
